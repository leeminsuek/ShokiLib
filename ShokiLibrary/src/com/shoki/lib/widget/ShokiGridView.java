...
public class ShokiGridView extends GridView {
    ...
    public ShokiGridView(Context context) {
        super(context);
        initHeaderGridView();
    }

    public ShokiGridView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initHeaderGridView();
    }

    public ShokiGridView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void addHeaderView(View v, int height) {
        addHeaderView(v, null, true, height);
    }
     ...
     */
    public void addHeaderView(View v, Object data, boolean isSelectable, int height) {
        ListAdapter adapter = getAdapter();
        if (adapter != null && !(adapter instanceof HeaderViewGridAdapter)) {
...
//        if (lyp != null) {
            v.setLayoutParams(new FrameLayout.LayoutParams(android.view.ViewGroup.LayoutParams.MATCH_PARENT, height));
            fl.setLayoutParams(new AbsListView.LayoutParams(android.view.ViewGroup.LayoutParams.MATCH_PARENT, height));
//        }
        fl.addView(v);
        info.view = v;
    ...
    private class FullWidthFixedViewLayout extends FrameLayout {
        ...
        protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
            int realLeft = ShokiGridView.this.getPaddingLeft() + getPaddingLeft();
        ...
        @Override
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            int targetWidth = ShokiGridView.this.getMeasuredWidth()
                    - ShokiGridView.this.getPaddingLeft()
                    - ShokiGridView.this.getPaddingRight();
