package com.shoki.lib.material;
...
public class MaterialProgress extends android.app.Dialog{
	...
	public MaterialProgress(Context context,String title) {
		super(context, android.R.style.Theme_Translucent);
		this.title = title;
		this.context = context;
	}
	
	public MaterialProgress(Context context,String title, int progressColor) {
		super(context, android.R.style.Theme_Translucent);
		this.title = title;
	...
	@Override
	  protected void onCreate(Bundle savedInstanceState) {
	    ...
	    setContentView(R.layout.layout_materialprogress);
		...
		anim.setAnimationListener(new AnimationListener() {
			...
			public void onAnimationEnd(Animation animation) {
				view.post(new Runnable() {
					@Override
					public void run() {
						MaterialProgress.super.dismiss();
			        }
			    });
